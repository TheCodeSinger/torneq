...
class Target(models.Model):
    ...
    status_desc = models.CharField(max_length=128, blank=True, null=True)
    status_details = models.CharField(max_length=128, blank=True, null=True)
    status_state = models.CharField(max_length=128, blank=True, null=True)
